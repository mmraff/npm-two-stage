...
/*
  alt-git passes this.opts, which includes cache, log, multipleRefs, noShrinkwrap.
  Sometimes we add spec to this, so that we can return the same integrity value
  as for a previous call.
*/
