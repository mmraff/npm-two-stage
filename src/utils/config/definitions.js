...
define('package-json', {
  ...
  description: `
    Refer to dependency list(s) in a package.json file for what to download.
    If <path/that/has/one> is not given, the package.json file is expected
    to be in the current directory.
    The -J form assumes this.
  `,
  flatten,
})
