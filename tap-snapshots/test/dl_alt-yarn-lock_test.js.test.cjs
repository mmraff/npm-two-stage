 ...
 */
'use strict'
exports[`test/dl_alt-yarn-lock_test.js TAP tap-with-yarn-lock > generated output from input 1`] = `
...
exports[`test/dl_alt-yarn-lock_test.js TAP yarn-stuff > generated output from input 1`] = `
# THIS IS AN AUTOGENERATED FILE. DO NOT EDIT THIS FILE DIRECTLY.
# yarn lockfile v1
