...
makeAssets('tempAssets3', 'offliner/alt-arborist.js', { offliner: true })
.then(assets => {

  const AltArborist = require(assets.libOffliner + '/alt-arborist')
  const arbLibPath = assets.nodeModules + '/@npmcli/arborist/lib'
  const mockGetWSNodes = require(arbLibPath + '/get-workspace-nodes')
