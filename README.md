...
First install the npm registry package **@offliner/npm2stage-v7.24.2**, a
...
2. Use **npm** to uninstall **@offliner/npm2stage-v7.24.2**.
3. Clear the cache: `npm cache clear --force`
4. Use **npm** to re-install **@offliner/npm2stage-v7.24.2**.
