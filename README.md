...
First install the npm registry package **@offliner/npm2stage-v8.19.4**, a
...
2. Use **npm** to uninstall **@offliner/npm2stage-v8.19.4**.
...
4. Use **npm** to re-install **@offliner/npm2stage-v8.19.4**.
